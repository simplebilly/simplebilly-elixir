...
defmodule SimpleBillyAPI.Connection do
  @moduledoc """
  Handle Tesla connections for SimpleBillyAPI.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, SimpleBillyAPI.Connection,
        base_url: "https://demo.simplebilly.com",
        adapter: Tesla.Adapter.Hackney

  The default base URL can also be set as:

      config :simple_billy_api,
        :base_url, "https://demo.simplebilly.com"
  """
  ...
  @doc """
  Configure a SimpleBillyAPI client.

  ### Parameters

  - `options`: an optional keyword list of SimpleBillyAPI.Connection.options.
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:simple_billy_api, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - SimpleBillyAPI 1.0.0 - elixir"
        )
      )
